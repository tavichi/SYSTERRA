    ...
    public function TiposSectores() {
	 ...
	 Public function TraeClientes($complemento){
		 ...
		 Public function Traedata($filtros){
			 ...
			 $query=$this->db->query("SELECT k.nombre as ntipodoc,j.serie,j.id_serie,k.id_tipodoc,a.recibo,
											...
											' GROUP BY a.recibo,a.id_serie,a.id_tipodoc,a.id_empresa');
		 ...
		 Public function DetalleRecibo($recibo,$serie,$tipodoc,$empresa){
			 ...
			 $query=$this->db->query("SELECT a.linea,(case when a.id_producto=1 then concat(b.nombre,' ',m.nombrec,'-',a.anno) else b.nombre end) as nombre,c.simbolo as moneda,(a.base+a.iva)as totallinea 
