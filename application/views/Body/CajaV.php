		...
		<div class="container">
		  <div class="row">
		    <div class="col-sm-3 col-md-9 col-lg-9">
		    	<h2><?php echo $nombreopcion?>&nbsp;<small><a class="fa fa-info-circle" data-toggle="tooltip" title="Manual de Usuario" id="ManualUsuario" href="<?php echo base_url(); ?>assets/Manuales/Manual de Usuario 0009 - Anulacion de Recibos Caja.pdf" target="_blank"></a></small></h2>
		    	<hr>
		    </div>
		</div>
	</div>
           			...
           			<div class="col-lg-8">
						  ...
						  <div class="form-group">
						   ...
						   <div class="form-group">
							    ...
							    <div class="col-lg-4">
								<input class="form-control" id="txtmontopago" type="text" placeholder="Ingrese Cantidad">
							    </div>
						   </div>
           					<div class="form-group">
        	...
        	if( $("#CmbTSector").val()==0){
        		...
        		if( $("#CmbSector").val()==0){
					...
					return false;
		              ...
		              $.ajax({
		                url: '<?php echo base_url('CajaAjax/cargardatos');?>',
		                type:'POST',
	         		...
	         		if (contador==0){
						...
						.then((value) => {
						  switch (value) {
						    case true:
									$.ajax({
								                url: '<?php echo base_url('CajaAjax/AnularBloque');?>',
								                type:'POST',
		...
		swal("Realmente Desea Realizar este Pago?", {
			...
			.then((value) => {
			  switch (value) {
			    case true:
					$.ajax({
				            url: '<?php echo base_url('CajaAjax/PagarRecibo');?>',
				            type:'POST',
...
function VerDetalleRecibo(){
	...
	$(".verdetalles").click(function(){
	 ...
	 empresa=parametros[3];
		$.ajax({
	                url: '<?php echo base_url('CajaAjax/DetalleRecibo');?>',
	                type:'POST',
...
function PagarRecibo(){
	...
	$(".pagar").click(function(){
		$("#txtmontopago").numeric(",");
  		 $("#txtparametropagooculto").val(this.id);
