...
sweetAlert = swal = function () {
  ...
  switch (typeof customizations) {
    ...
    case 'object':
      ...
      //console.log(params['selector']+"asdfasdf");
...
/*
 * Validation of the input field is done by user
 * If something is valid => call showInputSuccess with successMessage
 */
sweetAlert.showInputSuccess = swal.showInputSuccess = function (successMessage) {
  var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();

 /* var $errorIcon = modal.querySelector('.sa-input-error');
  _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide$isDescendant$getTopMargin$fadeIn$fadeOut$fireClick$stopEventPropagation.addClass($errorIcon, 'show');*/

  var $errorContainer = modal.querySelector('.sa-success-container');
  _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide$isDescendant$getTopMargin$fadeIn$fadeOut$fireClick$stopEventPropagation.addClass($errorContainer, 'show');

  $errorContainer.querySelector('p').innerHTML = successMessage;
...
var defaultParams = {
  ...
  confirmButtonColor: '#124b85',//'#AEDEF4',
...
var handleButton = function handleButton(event, params, modal) {
  ...
  switch (e.type) {
    ...
    case 'focus':
      ...
      var $cancelButton = modal.querySelector('button.swal_cancel');
    ...
    case 'click':
      ...
      if (targetedConfirm && doneFunctionExists && modalIsVisible) {
        ...
        sweetAlert.close();
        if(e.clientX != 0 && e.clientY != 0 && params['selector'] != undefined && params['selector'] != "" ){
          $(jq(params['selector'])).focus().select();
...
"<h2>Title</h2>\n    <p>Text</p>\n    <fieldset>\n      <input type=\"text\" tabIndex=\"3\" id=\"swal_input\" />  \n      <div class=\"sa-input-error\"></div>\n    </fieldset>" +

// Input errors
"<div class=\"sa-error-container\">\n      <div class=\"icon\">!</div>\n      <p>Not valid!</p>\n    </div>" +

// Input success
"<div class=\"sa-success-container\">\n      <div class=\"icon-check\">\u2714</div>\n      <p>Not valid!</p>\n    </div>" +
// Cancel and confirm buttons
"<div class=\"sa-button-container\">\n   <button class=\"confirm\" tabIndex=\"1\">OK</button>\n    <button class=\"swal_cancel\" tabIndex=\"2\">Cancel</button>\n      </div>" +
...
var setParameters = function setParameters(params) {
  ...
  var $cancelBtn = modal.querySelector('button.swal_cancel');
